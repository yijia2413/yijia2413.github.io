...
$(function() {
  ...
  var $NUM_POINTS = $('#num-points');
  var NUM_POINTS = parseInt($NUM_POINTS.val(),10);
  ...
  var cross = d3.svg.symbol().type('cross').size(function(d) { return 200; });
  var colors = d3.scale.category10();
  var small_point_colors = d3.scale.category20();
  ...
  rangeSlider($rangeSlider[0], {
    value: randomness,
    drag: function(value) {
      //reset the points to be clustered
      randomness = value;
      resetPoints();
    }
  });
  ...
  function resetPoints() {
    ...
    //var percentageClusteredPoints = (100 - 0.9 * randomness) / 100;
    var percentageClusteredPoints = 0.75;
    numClusters = parseInt($numClusters.val(), 10);
    
    NUM_POINTS = parseInt($NUM_POINTS.val(),10);
